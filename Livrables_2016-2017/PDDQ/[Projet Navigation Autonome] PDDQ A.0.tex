...
\begin{center}
    ...
    PDDQ & A & 0 & 27/10/2016 & 09/11/2016 \\ \hline
    \end{tabular}
\end{center}
...
\begin{figure}[h]
  \centering
\noindent\includegraphics[scale=0.5]{arbreproduit.png} 
...
\begin{figure}[h]
  \centering
\noindent\includegraphics[scale=0.55]{roadmap.png} 
  \caption{Roadmap}
\end{figure}
...
La figure \ref{lottaches} représente nos lots de tâches pour l'ensemble du projet, nous en avons identifié six.

\subsection{Planning général}

\begin{figure}[h]
  \centering
\noindent\includegraphics[scale=0.35]{general.png} 
...
\begin{figure}
  \centering
\noindent\includegraphics[scale=0.55]{lottaches.png} 
...
On peut voir sur la figure \ref{W1} le planning de la première période de projet W1.
...
\label{AssuranceQualiteStandardsDocuments}
...
\verb|[Projet Navigation Autonome] Nom du document Version|
...
\begin{figure}[h]
  \centering
\noindent\includegraphics[width=15cm]{risques.png} 
...
\begin{figure}[h]
  \centering
\noindent\includegraphics[width=15cm]{Tests_etape1.jpg} 
