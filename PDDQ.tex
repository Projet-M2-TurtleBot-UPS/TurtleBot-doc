...
\begin{description}
\item [GanttProject] : Outil de gestion de projet en mode diagrammes de Gantt. Il nous permet de planifier la réalisation des tâches globales sur toute la durée du projet et pendant les sprints. 
