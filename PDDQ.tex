...
ARBRE %\noindent\includegraphics[width=\textwidth]{arbreproduit.png} 
...
DIAGRAMME
% \noindent\includegraphics[width=\textwidth]{lottaches.png} 
...
GANTT OK %\noindent\includegraphics[width=\textwidth]{W1.png} 
...
\begin{itemize}
\item La branche \textit{master} contient uniquement un système complet en état de fonctionner.
\item Pour travailler sur quelque chose de nouveau , on créé une nouvelle branche à partir de la branche \textit{master}.
\item Lorsque la branche de modification est prête, on ouvre une \textit{Pull Request} pour demander une intégration à la branche master.
...
TABLEAU  %\noindent\includegraphics[width=\textwidth]{risques.jpg} 
