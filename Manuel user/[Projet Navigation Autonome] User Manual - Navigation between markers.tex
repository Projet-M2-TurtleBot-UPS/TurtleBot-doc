...
\begin{center}
    ...
    User Manual - Navigation & A & 5 & 30/03/2017 & 5/04/2017 \\ 
...
\begin{center}
    ...
    A.5 & Review  & Bruno Dato & 05/04/2017\\ \hline
...
\item[•] Package $ar\_track\_alvar$ \begin{verbatim}> sudo apt-get install ros-indigo-ar-track-alvar \end{verbatim}
\end{itemize}
...
To execute the navigation from a remote PC, fist you have to ssh to the TurtleBot PC to launch the minimal and vision features. Open a first terminal and write the following commands :
