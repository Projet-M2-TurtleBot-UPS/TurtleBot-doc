...
\begin{center}
    ...
    PDDQ & 1.0 & 30/10/2017 & 08/11/2017 \\ \hline
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    1.0 & Création et intégration du document & Pierre Beauhaire & 30/10/2017\\ \hline
...
\item [Étape 3] Réaliser une tâche de navigation dans un environnement supposé inconnu et avec obstacles pour atteindre un amer final en se déplaçant d’amer en amer (2D) afin de ne pas se perdre et en optimisant un critère (distance, temps, commande,....).

\end{description}

La première étape a pour objectif de prendre en main les différentes ressources à notre disposition. Il n'y a donc pas de réelle étape de spécification et de conception contrairement aux étapes suivantes. Celles-ci apparaîtront dans les futures version de ce document.
...
\item [Décision] : décrit les fonctions nécessaires aux différentes décisions que le robot doit prendre comme pour la génération de la trajectoire (en choisissant la trajectoire la plus courte et la plus rapide à prendre selon l’orientation du robot) et les décisions pour les différents événements possibles.
\item [Action] : Concerne toutes les fonctions correspondant au domaine de la commande robotisée permettant le respect des consignes (atteindre un amer, …), la réalisation des mouvements, et les contraintes cinématiques. On parlera aussi de l’odométrie.
\end{description}

\begin{figure}[h]
  \centering
\noindent\centerline{\includegraphics[scale=0.4]{Arbre_produit.png}}
...
\begin{center}
  \noindent\centerline{\includegraphics[scale=0.55]{Roadmap.png}}
  \\FIGURE 3 - Roadmap
\end{center}
...
\begin{figure}[h]
  \centering
\noindent\centerline{\includegraphics[scale=0.35]{Gantt.png}}
...
\item Plan de Développement et de Qualité V2 : au début de la Release2
\item Code Release2 et Manuel Utilisateur Release2 : à définir lors de la Release2
...
\item Code Release3 et Manuel Utilisateur Release3 : à définir lors du Release3
...
\begin{itemize}
\item Scrum Master (Who's the boss ?) : Responsable du processus de développement.
...
\begin{center}
\noindent\centerline{\includegraphics[scale=0.5]{Analyse_des_risques1.png}}
\noindent\centerline{\includegraphics[scale=0.5]{Analyse_des_risques2.png}}
  \\FIGURE 4 - Analyse des risques
\end{center}
