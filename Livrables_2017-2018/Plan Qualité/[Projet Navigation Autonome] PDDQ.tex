...
\begin{figure}[!h]
  \noindent\centerline{\includegraphics[scale=0.5]{Roadmap.png}}
  \caption{Roadmap}
\end{figure}
...
\begin{figure}[!h]
  \centering
\noindent\centerline{\includegraphics[scale=0.3]{Backlog.png}}
  \caption{Backlog de la Release1}
\end{figure}
...
\begin{figure}[!h]
  \centering
\noindent\centerline{\includegraphics[scale=0.3]{Gantt.png}}
...
\begin{itemize}
\item Scrum Master (Pierre Beauhaire) : Responsable du processus de développement.
...
\begin{figure}[!h]
  \centering
  \noindent\centerline{\includegraphics[scale=0.4]{Analyse_des_risques.png}}
